...
# Plot performance statistics from temporary copy of this file
PERFLOGFILE="/home/xsvenda/btc/memlog.csv"
echo "Performance file: $PERFLOGFILE"
cp "$PERFLOGFILE" "$PERFLOGFILE.tmp"
python3 -m helpers.perf_processing "$PERFLOGFILE.tmp"
cp "$PERFLOGFILE.png" "$TMP_DIR/"
cp "$PERFLOGFILE.tmp" "$TMP_DIR/"
